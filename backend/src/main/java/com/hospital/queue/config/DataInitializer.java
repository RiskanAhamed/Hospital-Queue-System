...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // FIX #10: Create the appointment as BOOKED first, generate queue entry,
        // then manually set BOTH the appointment AND queue entry to COMPLETED after.
        ...
        // Now manually mark both as COMPLETED (after queue generation set them to CHECKED_IN/WAITING)
