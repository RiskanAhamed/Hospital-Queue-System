...
export default function RescheduleScreen() {
  ...
  const { apptId, doctorId, doctorName, specialty } = params;
  ...
  useEffect(() => {
    ...
    const fetchAvailability = async () => {
      ...
      try {
        ...
        // Fetch already booked appointments for this doctor, ignoring cancelled ones and the current appointment itself
    ...
    fetchAvailability();
  }, [doctorId, selectedDate, hospitalId, apptId]);
  ...
  const handleRescheduleConfirm = async () => {
    ...
    try {
      const res = await authFetch(`/hospitals/${hospitalId}/appointments/${apptId}/reschedule`, {
        method: 'POST',
      ...
      Alert.alert(
        'Success 🎉',
        `Rescheduled successfully to ${selectedDate} at ${formatSlotTime(selectedSlot)}`,
        [
          {
            text: 'OK',
            onPress: () => {
      ...
      Alert.alert('Reschedule Failed', error.message || 'Connection error.');
    } finally {
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.doctorSummaryCard}>
          ...
          <Text style={styles.docSpecialty}>{specialty || 'General Medicine'}</Text>
        </View>
      ...
      <View style={styles.footer}>
        ...
        >
          {rescheduleLoading ? (
            ...
            <Text style={styles.btnConfirmText}>Confirm Reschedule</Text>
          )}
        </TouchableOpacity>
      </View>
    </View>
